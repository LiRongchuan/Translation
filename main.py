...
transcription = ['']
text_date = Queue()
App_id = os.getenv('appid', '20250624002388885')
App_key = os.getenv('appkey', 'qfLMsMYKyagAocboulL_')
...
def create_window():
    ...
    window.attributes('-alpha', 100)  # 设置窗口透明度
    ...
    english_text = tk.Label(frame, text=E_text, bg="white", fg="black")
    chinese_text = tk.Label(frame, text=C_text, bg="white", fg="black")
